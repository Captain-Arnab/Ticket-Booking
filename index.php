        ...
        <div class="row">
          <div class="col-11 col-md-10 mx-auto">
            ...
            <form id="loginForm" method="post">
              <div class="form-group">
                <input type="email" class="form-control" id="emailmobile" required placeholder="Mobile or Email">
              </div>
              <div class="form-group">
              ...
              <button class="btn btn-primary btn-block my-4" id="btn_login" type="submit">Login</button>
...
<script>
 ...
 if(emailmobile == ''){ //check email not empty
      ...
      $.ajax({
        ...
        data: 
          {
           newemailmobile:emailmobile, 
           newpassword:password
          },
        success: function(response){
         if(response=="ok")
          {
            $('#message').html('<div class="alert alert-success"><button type="button" class="close" data-dismiss="alert">&times;</button> Signing In... </div>');
            setTimeout(' window.location.href = "useradmin/dashboard.php"; ',1000);
          }
          else
          {
...
<script>
  ...
  $(document).on('click','#btn_register',function(e){
   ...
   var password = $('#loginpa').val();
    var cmpassword = $('#ConfirmPassword').val();
    var zip = $('#zipcode').val();
   ...
   alert('Please Enter Username !!'); 
      ...
      alert('It checks that the password entered by the user is same as this confirm password fields.'); 
    }
    else if(zip == ''){ //check password not empty
        alert('Please Enter Zip !!'); 
      }
      else if(phoneno == ''){ //check password not empty
        ...
        <div class="row">
          <div class="col-11 col-md-10 mx-auto">
            ...
            <form id="signupForm" method="post">
              ...
              <div class="form-group">
                <input type="email" class="form-control border-2" id="emailadd" required placeholder="Email Id">
              </div>
              <div class="form-group">
                <input type="password" class="form-control border-2" id="loginpa" required placeholder="Password">
              </div>
               <div class="form-group">
                <input type="password" class="form-control border-2" id="ConfirmPassword" required placeholder="Confirm Password">
              </div>
               <div class="form-group">
                <input type="text" class="form-control border-2" id="zipcode" required placeholder="Zip Code">
              </div>
               <div class="input-group">
                <input type="tel" class="form-control border-2" id="phoneno" required placeholder="Phone Number">
              </div>
              ...
              <button class="btn btn-primary btn-block my-4" id="btn_register" type="submit">Sign Up</button>
                <div class="form-group">
